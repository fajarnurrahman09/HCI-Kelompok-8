            ...
            <div class="container">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#infokommodaledit<?php echo $data['id'] ?>"><i class="fa fa-edit" aria-hidden="true"></i>edit</button>
                                        <a href="../buttondelete/DLTinfokom.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <!-- Modal Edit -->
                            ...
                            if (isset($_POST['ubah'])) {
                                ...
                                if ($image != "") {
                                    ...
                                    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
                                        ...
                                        $query = "UPDATE tabel_dinfokom SET nama = '$nama', deskripsi = '$deskripsi', foto = '$nama_gambar_baru' WHERE id = '$id'";
                                        ...
                                        if (!$result) {
                                            ...
                                            echo "<script>alert('Data berhasil diedit.');window.location='infokom.php';</script>";
                                        }
                                    } else {
                                        //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                                        echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='infokom.php';</script>";
                                    }
                                } else {
                                    $query = "UPDATE tabel_dinfokom SET nama = '$nama', deskripsi = '$deskripsi' WHERE id = '$id'";
                                    $result = mysqli_query($koneksi, $query);
                                    // periska query apakah ada error
                                    if (!$result) {
                                        die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
                ...
                <div class="modal fade" id="infokommodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="infokommodalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="infokommodalLabel">Divisi INFOKOM</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data">
            ...
            if (isset($_POST['simpan'])) {
                ...
                if ($image != "") {
                    ...
                    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
                        move_uploaded_file($file_tmp, 'gambar/' . $nama_gambar_baru); //memindah file gambar ke folder gambar
                        // jalankan query INSERT untuk menambah data ke database pastikan sesuai urutan (id tidak perlu karena dibikin otomatis)
                        $query = "INSERT INTO tabel_dinfokom (nama, deskripsi, foto) VALUES ('$nama','$deskripsi','$nama_gambar_baru')";
                        $result = mysqli_query($koneksi, $query);
                        // periska query apakah ada error
                        if (!$result) {
                            die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
                            ...
                            //tampil alert dan akan redirect ke halaman index.php
                            //silahkan ganti index.php sesuai halaman yang akan dituju
                            echo "<script>alert('Data berhasil ditambah.');window.location='infokom.php';</script>";
                        }
                    } else {
                        //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                        echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='infokom.php';</script>";
                    ...
                    $query = "INSERT INTO tabel_dinfokom (nama, deskripsi, foto) VALUES ('$nama', '$deskripsi', null)";
                    $result = mysqli_query($koneksi, $query);
                    // periska query apakah ada error
                    if (!$result) {
                        die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
